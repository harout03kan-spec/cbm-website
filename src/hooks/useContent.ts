...
const DEFAULTS: SiteContent = {
  ...
  home_trust_bar: {
    stat1_value: 'Montreal', stat1_label: 'Repair Center',
    stat2_value: 'Canada-wide', stat2_label: 'Sales & Service',
    stat3_value: 'In-house', stat3_label: 'Board-level Repairs',
    stat4_value: 'New & Used', stat4_label: 'ASIC Miners',
  },
  home_repair_teaser: {
    heading: 'Need Your ASIC Miner Repaired?',
    body: 'Our Montreal repair center specializes in hashboard diagnostics and board-level ASIC repairs to get miners back online.',
    flow_line: 'Send us your miner or boards → we diagnose the issue → we send a quote → we complete the repair',
    point1: 'Montreal repair center',
    point2: 'Hashboard diagnostics & repair',
    point3: 'Cleaning and testing',
    point4: 'Quote before any work',
  ...
  faq_repair: [
    ...
    { question: 'What is your average turnaround time?', answer: 'Turnaround depends on the fault, the model, and parts. We confirm the expected timeline with your quote before any work begins.' },
  ...
  services_trust_points: [
    { point: 'Montreal Repair Center' }, { point: 'Canada-wide Repair Intake' },
    { point: 'Hashboard Diagnostics' }, { point: 'Cleaning and Testing' },
